...
"""
name = playesrs[0]["name"]
numbers = playesrs[0]["numbers"].intersection(lottery_numbers)
print(f"Player {name} got {len(numbers)} numbers right")

name = playesrs[1]["name"]
numbers = playesrs[1]["numbers"].intersection(lottery_numbers)
print(f"Player {name} got {len(numbers)} numbers right")
